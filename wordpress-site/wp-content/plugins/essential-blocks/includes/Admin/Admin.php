...
class Admin {
    ...
    public function promotion_message_on_admin_screen() {
        ...
        $message_template = __(
            "<p><i>📣</i> Introducing Facebook Feed in <strong>Essential Blocks 6.3.0 and Essential Blocks PRO 3.0.0</strong> - Showcase your latest Facebook posts on any WordPress page with a sleek, customizable feed block! For more details, check out this <strong><a target='_blank' href='%s'>changelog</a></strong>.</p>",
            "essential-blocks"
        );
