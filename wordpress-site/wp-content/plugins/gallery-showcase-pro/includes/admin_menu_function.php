 ...
 * @since   1.0.0
 */
add_meta_box('submitdiv', sprintf(__('Publish', 'gallery-showcase-pro')), 'gspwp_layouts_submit_meta_box', 'gs_layouts', 'side', 'high');
        ...
        <div class="submitbox" id="submitpost">
            ...
            <div id="major-publishing-actions">
                ...
                <div id="delete-action">
                    <?php
                    if (!EMPTY_TRASH_DAYS) {
                        $delete_text = esc_html__('Delete Permanently', 'gallery-showcase-pro');
                    } else {
                        $delete_text = esc_html__('Move to Trash', 'gallery-showcase-pro');
                    }
                    ?>
                ...
                <div id="publishing-action">
                    ...
                    if (!in_array($post->post_status, array('publish', 'future', 'private')) || 0 == $post->ID) {
                        if ($can_publish) :
                            ...
                            submit_button(sprintf(esc_html__('Add', 'gallery-showcase-pro')), 'primary button-large', 'publish', false, array('accesskey' => 'p'));
                        endif;
                    } else {
                        ?>
