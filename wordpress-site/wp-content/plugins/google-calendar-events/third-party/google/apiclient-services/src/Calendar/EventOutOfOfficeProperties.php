...
class EventOutOfOfficeProperties extends \SimpleCalendar\plugin_deps\Google\Model
{
    /**
     * @var string
     */
...
class_alias(EventOutOfOfficeProperties::class, 'SimpleCalendar\plugin_deps\Google_Service_Calendar_EventOutOfOfficeProperties');
