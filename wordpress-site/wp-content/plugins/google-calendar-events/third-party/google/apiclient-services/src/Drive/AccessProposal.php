...
class AccessProposal extends \SimpleCalendar\plugin_deps\Google\Collection
{
...
class_alias(AccessProposal::class, 'SimpleCalendar\plugin_deps\Google_Service_Drive_AccessProposal');
