...
class ListAccessProposalsResponse extends \SimpleCalendar\plugin_deps\Google\Collection
{
...
class_alias(ListAccessProposalsResponse::class, 'SimpleCalendar\plugin_deps\Google_Service_Drive_ListAccessProposalsResponse');
