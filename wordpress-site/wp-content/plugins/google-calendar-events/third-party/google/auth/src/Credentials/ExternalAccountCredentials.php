...
use SimpleCalendar\plugin_deps\Google\Auth\CredentialSource\AwsNativeSource;
use SimpleCalendar\plugin_deps\Google\Auth\CredentialSource\ExecutableSource;
use SimpleCalendar\plugin_deps\Google\Auth\CredentialSource\FileSource;
use SimpleCalendar\plugin_deps\Google\Auth\CredentialSource\UrlSource;
use SimpleCalendar\plugin_deps\Google\Auth\ExecutableHandler\ExecutableHandler;
use SimpleCalendar\plugin_deps\Google\Auth\ExternalAccountCredentialSourceInterface;
...
use SimpleCalendar\plugin_deps\Google\Auth\GetUniverseDomainInterface;
...
use SimpleCalendar\plugin_deps\Google\Auth\UpdateMetadataTrait;
