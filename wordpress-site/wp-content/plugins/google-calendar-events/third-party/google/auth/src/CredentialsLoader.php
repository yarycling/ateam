...
use SimpleCalendar\plugin_deps\Google\Auth\Credentials\ExternalAccountCredentials;
use SimpleCalendar\plugin_deps\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
