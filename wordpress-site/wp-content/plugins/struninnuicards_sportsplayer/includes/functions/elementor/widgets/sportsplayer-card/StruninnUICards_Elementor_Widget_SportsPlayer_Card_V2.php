...
if (!class_exists('StruninnUICards_Elementor_Widget_SportsPlayer_Card_V2')) {
  /**
   * Video List Elementor Widget.
   * 
   * @since 1.0.0
   */
  class StruninnUICards_Elementor_Widget_SportsPlayer_Card_V2 extends \Elementor\Widget_Base {
    ...
    public function get_name() {
      return 'StruninnUICards_Elementor_Widget_SportsPlayer_card_v2';
    }
  
    public function get_title() {
      return esc_html__('Struninn UI Card - Sports Player V2', 'struninnuicards_sportsplayer');
    }
