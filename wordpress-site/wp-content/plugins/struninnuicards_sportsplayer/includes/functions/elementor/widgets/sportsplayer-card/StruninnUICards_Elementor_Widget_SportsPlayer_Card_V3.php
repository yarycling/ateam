...
if (!class_exists('StruninnUICards_Elementor_Widget_SportsPlayer_Card_V3')) {
  /**
   * Video List Elementor Widget.
   * 
   * @since 1.0.0
   */
  class StruninnUICards_Elementor_Widget_SportsPlayer_Card_V3 extends \Elementor\Widget_Base {
    ...
    public function get_name() {
      return 'StruninnUICards_Elementor_Widget_SportsPlayer_card_v3';
    }
  
    public function get_title() {
      return esc_html__('Struninn UI Card - Sports Player V3', 'struninnuicards_sportsplayer');
    }
    ...
    protected function register_controls() {
      ...
      $this->add_control(
        'struninnuicards_sportsplayer_card_tag',
        [
          'label'       => esc_html__('Tag', 'struninnuicards_sportsplayer'),
          'type'        => \Elementor\Controls_Manager::TEXT,
          'input_type'  => 'text',
    ...
    protected function render() {
      ...
      $args = [
        ...
        'tag'               => $settings['struninnuicards_sportsplayer_card_tag'],
