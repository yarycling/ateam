...
if (!class_exists('StruninnUICards_Elementor_Widget_SportsPlayer_Card_V4')) {
  /**
   * Video List Elementor Widget.
   * 
   * @since 1.0.0
   */
  class StruninnUICards_Elementor_Widget_SportsPlayer_Card_V4 extends \Elementor\Widget_Base {
    ...
    public function get_name() {
      return 'StruninnUICards_Elementor_Widget_SportsPlayer_card_v4';
    }
  
    public function get_title() {
      return esc_html__('Struninn UI Card - Sports Player V4', 'struninnuicards_sportsplayer');
    }
    ...
    protected function register_controls() {
      ...
      $this->add_control(
        'struninnuicards_sportsplayer_card_pretitle',
        [
          'label'       => esc_html__('Pretitle', 'struninnuicards_sportsplayer'),
          'type'        => \Elementor\Controls_Manager::TEXT,
          'input_type'  => 'text',
          'default'     => $defaults['pretitle']
        ]
      );
      ...
      $this->add_control(
        'struninnuicards_sportsplayer_card_footer_right_title',
        [
          'label'       => esc_html__('Footer Right Title', 'struninnuicards_sportsplayer'),
          'type'        => \Elementor\Controls_Manager::TEXT,
          'input_type'  => 'text',
          'default'     => $defaults['footer_right_title']
        ]
      );
    ...
    protected function render() {
      ...
      $args = [
        ...
        'pretitle'            => $settings['struninnuicards_sportsplayer_card_pretitle'],
        ...
        'footer_right_title'  => $settings['struninnuicards_sportsplayer_card_footer_right_title'],
