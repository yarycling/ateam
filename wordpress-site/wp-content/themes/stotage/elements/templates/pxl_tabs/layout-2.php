...
if(isset($settings['tabs_l2']) && !empty($settings['tabs_l2']) && count($settings['tabs_l2'])): 
    $tab_bd_ids = [];
?>
<div class="pxl-tabs pxl-tabs2 <?php echo esc_attr($settings['tab_effect'].' '.$settings['pxl_animate'].' '.$settings['t_style']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
