...
if(isset($settings['tabs_l4']) && !empty($settings['tabs_l4']) && count($settings['tabs_l4'])): 
    $tab_bd_ids = [];
?>
<div class="pxl-tabs pxl-tabs7 <?php echo esc_attr($settings['tab_effect'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
